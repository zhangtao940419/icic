 ...
 * Generated for Laravel 5.6.26 on 2018-07-26 09:32:42.
 *
...
namespace Earnp\Getui\Facades { 
    ...
    class Getui {
        ...
        {
            return \Earnp\Getui\Getui::IGtPush();
        }
        ...
        {
            return \Earnp\Getui\Getui::getPersonaTags();
        }
        ...
        {
            return \Earnp\Getui\Getui::stopPushTask($taskId);
        }
        ...
        {
            return \Earnp\Getui\Getui::getUserStatus($CID);
        }
        ...
        {
            return \Earnp\Getui\Getui::getUserCountByTags($tagList);
        }
        ...
        {
            return \Earnp\Getui\Getui::getPushMessageResult($taskId);
        }
        ...
        {
            return \Earnp\Getui\Getui::getUserDataByDate($date);
        }
        ...
        {
            return \Earnp\Getui\Getui::getPushDataByDate($date);
        }
        ...
        {
            return \Earnp\Getui\Getui::pushMessageToSingle($template, $config, $data, $CID);
        }
        ...
        {
            return \Earnp\Getui\Getui::pushMessageToList($template, $config, $data, $CID);
        }
        ...
        {
            return \Earnp\Getui\Getui::pushMessageToApp($template, $config, $data, $choice);
        }
        ...
        {
            return \Earnp\Getui\Getui::IGtTransmissionTemplate($data, $config);
        }
        ...
        {
            return \Earnp\Getui\Getui::IGtNotificationTemplate($data, $config);
        }
        ...
        {
            return \Earnp\Getui\Getui::IGtLinkTemplate($data, $config);
        }
        ...
        {
            return \Earnp\Getui\Getui::IGtNotyPopLoadTemplate($data, $config);
        }
...
namespace  { 
    ...
    class Getui extends \Earnp\Getui\Facades\Getui {}
