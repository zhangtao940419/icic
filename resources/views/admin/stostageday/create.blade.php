...
@section('content')
    ...
    <div class="page-header">
       ...
       <form class="form-horizontal" role="form" method="post" action="{{ route('stoStage.store') }}">
        {{ csrf_field() }}
        ...
        <div class="form-group">
               ...
               <div class="col-sm-9">
                   <input type="text" name="stage_issue_number" id="form-field-1" placeholder="货币总量" class="col-xs-10 col-sm-5" value="" />
               </div>
           </div>
           <div class="form-group">
               <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 兑率 </label>
               <div class="col-sm-9">
                   <input type="text" name="exchange_rate" id="form-field-1" placeholder="兑率(例如汇率0.5,则兑币 = 基币 *0.5)" class="col-xs-10 col-sm-5" value="" />
               </div>
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
               ...
               <div class="col-sm-9">
                   <input type="text" name="issue_time" id="form-field-1" placeholder="周期时长(以天为单位)" class="col-xs-10 col-sm-5" value="" />
               </div>
           </div>
           <div class="form-group">
               <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 每日开购时间 </label>
               <div class="col-sm-9">
                   <input type="time" name="start_time" id="form-field-1" placeholder="开始时间" class="col-xs-10 col-sm-5" value="" />
               </div>
           </div>
           <div class="form-group">
               <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 每日结束时间 </label>
               <div class="col-sm-9">
                   <input type="time" name="end_time" id="form-field-1" placeholder="开始时间" class="col-xs-10 col-sm-5" value="" />
               </div>
           </div>
        <div class="space-4"></div>
