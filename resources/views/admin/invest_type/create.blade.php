...
{{--        <form class="form-horizontal" role="form" method="post" action="{{ route('token.update', $token->token_id) }}">
            <input type="hidden" name="_method" value="PUT">--}}
                <form class="form-horizontal" role="form" method="post" action="{{ route('InvestmentType.store') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="invest_type_name" id="form-field-1" placeholder="理财类型名称" class="col-xs-10 col-sm-5" value="" />
                        </div>
                    </div>
