...
@section('content')
    ...
    <table id="simple-table" class="table  table-bordered table-hover">
        ...
        @foreach($insideTrades as $insideTrade)
            <tr>
                <td class="center">{{ $insideTrade->sell_id}}</td>
                ...
                <td class="center">
                    <div>
                        <a href="{{ route('insideTradesell.show', $insideTrade->sell_id) }}" class="btn btn-xs btn-info" title="查看交易详细">
